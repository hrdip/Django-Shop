...
DATABASES = {
    'default': {
        ...
        'PASSWORD': config("PGDB_PASSWORD",default='1234'),
...
# base on new role use staticfiles for STATIC_ROOT
STATIC_ROOT = BASE_DIR / 'staticfiles'
MEDIA_ROOT = BASE_DIR / 'media'

# this is our static and when we collecting static files this root copy on STATIC_ROOT directory
STATICFILES_DIRS = [
    BASE_DIR /'static',
] 
